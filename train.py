...
def main():
    ...
    parser.add_argument("--model_name", type=str, default="bert-base-uncased", help="pre-trained model name or path")
    parser.add_argument("--seed", type=int, default=42 , help="random seed value")
    parser.add_argument("--batch_size", type=int, required=True, help="batch size for training")
    parser.add_argument("--max_len", type=int, default=128, help="Maximum length of sequence")
